...
const [showMobileMenu, setShowMobileMenu] = useState(false);
  ...
  <div
    ...
    > 
      ...
      <img src={cartIcon} className="hidden md:block cursor-pointer"alt="/"></img>
     <HiMenuAlt3 
     size={30} 
     className="block md:hidden cursor-pointer text-white" 
     onClick={() => setShowMobileMenu((prev)=>!prev)}/>  
      
     <div className={`block md:hidden w-full fixed ${!setShowMobileMenu ? "-top-[410px]": "top-0"
...
<FadeIn delay={0.8} direction="down" padding fullwidth>
...
<FadeIn delay={0.4} direction="up" padding fullWidth>
  <div className="relative w-full xs:w-[460px] mt-11">
    <input type="text" placeholder="Search" className="rounded-full w-full pl-6 pr-[68px] py-4 bg-primary outline-none text-white
...
<div className="absolute h-[50px] xs:h-[150px] bottom-0 w-full bg-[linear-gradient(180deg,_#ffffff00_0%,_#FF_100%)]"/>
